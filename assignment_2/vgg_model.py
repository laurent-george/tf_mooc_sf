...
def _avgpool(prev_layer):
    ...
    Hint for choosing strides and kernel size: choose what you feel appropriate
    """
    avg_pool_layer = tf.keras.layers.AveragePooling2D(pool_size=(2, 2),
                                                      strides=(2, 2))(prev_layer)
